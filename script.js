...
function handleTileClick(index) {
  ...
  if (isSolved()) {
    puzzleStatus.textContent = "You solved it! ❤️";
...
function startPuzzle() {
  ...
  selectedIndex = null;
  puzzleStatus.textContent = "Great! Solve the puzzle to unlock your surprise message.";
  puzzleSection.classList.add("show");
  renderPuzzle();
}

/** Replace card content with the final celebration message. */
...
/**
 * After clicking Yes, the puzzle becomes mandatory.
 * The celebration card appears only after solving it.
 */
function celebrateYes() {
  yesButton.disabled = true;
  yesButton.textContent = "Puzzle unlocked 💖";
  startPuzzle();
}
